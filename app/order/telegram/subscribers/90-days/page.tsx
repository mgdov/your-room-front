...
const QUANTITY_OPTIONS = [
    { value: 100, label: "100", price: "52 ₽" },
    { value: 500, label: "500", price: "261 ₽" },
    { value: 1000, label: "1 000", price: "522 ₽", popular: true },
    { value: 2500, label: "2 500", price: "1 305 ₽" },
    { value: 5000, label: "5 000", price: "2 610 ₽" },
    { value: 10000, label: "10 000", price: "5 220 ₽" },
]

export default function Subscribers90DaysPage() {
    ...
    return (
        <PageLayout>
            <div className="max-w-2xl">
                ...
                <h1 className="text-3xl font-bold mb-6">Подписчики | 90 дней</h1>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6 mb-6">
                    ...
                    <div className="flex items-center justify-between py-4 border-t border-slate-700 mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-slate-500 line-through text-sm">540 ₽</span>
                ...
                <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-6 text-sm text-slate-300 space-y-3">
                    ...
                    <p className="flex items-start gap-2">
                        <span className="text-green-400">✓</span>
                        <span>Скорость: 1K-4K в сутки</span>
                    </p>
                </div>
            </div>
        </PageLayout>
