...
export default function ViewsSongSubscriptionPage() {
    ...
    return (
        <PageLayout>
            <div className="max-w-4xl">
                ...
                <h1 className="text-3xl font-bold mb-6">Просмотры лесенкой | Подписка</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
                            ...
                            <div className="flex items-center justify-between py-4 border-t border-slate-700 mb-6">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-slate-500 line-through text-sm">0.0</span>
                                </div>
                            </div>
                        ...
                        <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-6 text-sm text-slate-300 space-y-3">
                            <p className="text-white font-medium">Подписка на просмотры лесенкой в Telegram</p>
                            ...
                            <div className="pt-4 border-t border-slate-700 space-y-2">
                                ...
                                <p className="flex items-start gap-2">
                                    <span className="text-orange-400">⚠️</span>
                                    <span>В поле "Количество новых постов" укажите количество будущих публикаций для накрутки.</span>
                                </p>
                                <p className="flex items-start gap-2">
                                    <span className="text-orange-400">⚠️</span>
                            ...
                            <div className="pt-4 border-t border-slate-700">
                                <p className="text-slate-400">Каждая фотография в публикации считается отдельным постом, что бы отобразился корректный счетчик просмотров на публикации с несколькими фото, крутить нужно на каждое фото отдельно.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
                            ...
                            <div className="text-white font-bold text-lg">334</div>
                        </div>
