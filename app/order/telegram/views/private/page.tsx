...
const QUANTITY_OPTIONS = [
    { value: 100, label: "100", price: "17 ₽", emoji: "🔒" },
    { value: 500, label: "500", price: "86 ₽", emoji: "🔒" },
    { value: 1000, label: "1 000", price: "171 ₽", emoji: "🔒" },
    { value: 2500, label: "2 500", price: "43 ₽", emoji: "🔒" },
    { value: 5000, label: "5 000", price: "86 ₽", emoji: "🔒" },
    { value: 10000, label: "10 000", price: "171 ₽", emoji: "🔒" },
]

export default function ViewsPrivatePage() {
    ...
    return (
        <PageLayout>
            <div className="max-w-4xl">
                ...
                <h1 className="text-3xl font-bold mb-6">Просмотры для закрытых каналов | Читать описание</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
                            <div className="mb-6">
                                ...
                                <div className="flex justify-between text-sm text-slate-500 mt-2">
                                    <span className="text-green-400">мин 1</span>
                                    <span className="text-green-400">макс 200000</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between py-4 border-t border-slate-700 mb-6">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-white font-bold text-xl">171 ₽</span>
                                    <span className="bg-orange-500 text-white px-3 py-1 rounded text-sm font-medium">-5%</span>
                                    <span className="text-slate-500 line-through text-sm">18 ₽</span>
                                </div>
                            </div>
                        ...
                        <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-6 text-sm text-slate-300 space-y-3">
                            <p className="text-white font-semibold">1. Пригласите наш бот в канал - @hyperguardsecurity_bot и дайте ему администратора (без прав)</p>

                            <p className="text-white font-semibold">2. Вставьте линк на пост Просмотров 100% с СНГ (Россия, Украина и др.) (Услуга не будет работать если вы вставляете ссылку не релост с другого канала) ➡️ Попадать в статистику как просмотры именно с этих стран (Обязательно заранее добавьте наш бот в канал)</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
                            ...
                            <div className="text-white font-bold text-lg">333</div>
                        </div>
