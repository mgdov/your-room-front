...
const QUANTITY_OPTIONS = [
    { value: 100, label: "100", price: "6.6 ₽" },
    { value: 500, label: "500", price: "33 ₽" },
    { value: 1000, label: "1 000", price: "66 ₽" },
    { value: 2500, label: "2 500", price: "165 ₽" },
    { value: 5000, label: "5 000", price: "330 ₽" },
    { value: 10000, label: "10 000", price: "660 ₽" },
]

export default function ViewsStoryPage() {
    ...
    return (
        <PageLayout>
            <div className="max-w-4xl">
                ...
                <h1 className="text-3xl font-bold mb-6">Просмотры Story</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    placeholder="https://t.me/hyperlikeru/s/2"
                                    className="w-full bg-slate-800 text-white placeholder-slate-500 rounded-lg px-4 py-3 border border-slate-700 focus:outline-none focus:ring-2 focus:ring-purple-500"
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between py-4 border-t border-slate-700 mb-6">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-slate-500 line-through text-sm">60 ₽</span>
                                </div>
                            </div>
                        ...
                        <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-6 text-sm text-slate-300 space-y-3">
                            <p className="flex items-start gap-2">
                                ...
                                <span>Просмотры на TG Story</span>
                            </p>
                            <p className="flex items-start gap-2">
                            ...
                            <p className="flex items-start gap-2">
                                ...
                                <span>Скорость 50k/день</span>
                            </p>
                            <p className="flex items-start gap-2">
                                <span className="text-green-400">✓</span>
                                <span>Геолокация - МИР</span>
                            </p>
                            <p className="mt-4">Просмотры только для статичных стори, на видео стори не накрутится.</p>
                    ...
                    <div className="space-y-4">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
                            ...
                            <div className="text-white font-bold text-lg">228</div>
                        </div>
                        ...
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
                            <div className="flex items-center gap-2 text-orange-400">
                                <span>🚀</span>
                                <span className="font-medium">Скорость 50K в сутки</span>
                            </div>
                        </div>
                    </div>
                </div>
