...
const QUANTITY_OPTIONS = [
    { value: 100, label: "100", price: "11.3 ₽", emoji: "👀" },
    { value: 500, label: "500", price: "57 ₽", emoji: "👀" },
    { value: 1000, label: "1 000", price: "113 ₽", emoji: "👀" },
    { value: 2500, label: "2 500", price: "283 ₽", emoji: "👀" },
    { value: 5000, label: "5 000", price: "565 ₽", emoji: "👀" },
    { value: 10000, label: "10 000", price: "1131 ₽", emoji: "👀" },
]

export default function ViewsLast30Page() {
    ...
    return (
        <PageLayout>
            <div className="max-w-4xl">
                ...
                <h1 className="text-3xl font-bold mb-6">Просмотры на 30 последних постов в канале</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
                            ...
                            <div className="flex items-center justify-between py-4 border-t border-slate-700 mb-6">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-white font-bold text-xl">113 ₽</span>
                        ...
                        <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-6 text-sm text-slate-300 space-y-3">
                            <p className="text-white font-semibold">🔥 Просмотры на 30 последних постов</p>
