...
const QUANTITY_OPTIONS = [
    { value: 100, label: "100", price: "18 ₽", emoji: "👀" },
    { value: 500, label: "500", price: "90 ₽", emoji: "👀" },
    { value: 1000, label: "1 000", price: "180 ₽", emoji: "👀" },
    { value: 2500, label: "2 500", price: "448 ₽", emoji: "👀" },
    { value: 5000, label: "5 000", price: "898 ₽", emoji: "👀" },
    { value: 10000, label: "10 000", price: "1798 ₽", emoji: "👀" },
]

export default function ViewsLast50Page() {
    ...
    return (
        <PageLayout>
            <div className="max-w-4xl">
                ...
                <h1 className="text-3xl font-bold mb-6">Просмотры на 50 последних постов в канале</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
                            <div className="mb-6">
                                ...
                                <div className="flex justify-between text-sm text-slate-500 mt-2">
                                    <span className="text-green-400">мин 100</span>
                                    <span className="text-green-400">макс 10000000</span>
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    placeholder="t.me/hyperlike_boost/14"
                                    className="w-full bg-slate-800 text-white placeholder-slate-500 rounded-lg px-4 py-3 border border-slate-700 focus:outline-none focus:ring-2 focus:ring-purple-500"
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between py-4 border-t border-slate-700 mb-6">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-slate-500 line-through text-sm">189 ₽</span>
                                </div>
                            </div>
                        ...
                        <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-6 text-sm text-slate-300 space-y-3">
                            <p className="text-white font-semibold">🔥 Просмотры на 50 последних постов</p>

                            <p>🌿 Микс, больше боты</p>

                            <p className="text-orange-400">👉 В поле "Ссылка" вставьте ссылку на ваш канал</p>

                            <p>⏱ Время старта 0-1 час</p>
                            <p>⚡️ Скорость 100К/день</p>
                            <p>⚡️ ГЕО - Микс</p>

                            <p className="mt-4">После недавних обновлений в Телеграм, изменилась система накрутки постов с несколькими медиафайлами. Теперь каждый медиафайл имеет свою уникальную ссылку и считывается отдельно. Заказывая просмотры определенного количества старых постов, учитывайте количество медиафайлов в них.</p>

                            <p className="text-white font-semibold mt-4">Не забудьте следовать важным правилам:</p>
                            <p>- Канал должен быть открытым! 🌐</p>
                            <p>- "t.me/..." и "t.me/joinchat..." НЕ принимаются! 🚫</p>
                            <p>- Запрещённые тематики: наркотики, скам, пустые каналы 🚫</p>

                            <p className="text-orange-400">Если заказ отменён - вы не выполнили одно из условий. 👍</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
                            ...
                            <div className="text-white font-bold text-lg">148</div>
                        </div>
                        ...
                        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
                            <div className="flex items-center gap-2 text-orange-400">
                                <span>🚀</span>
                                <span className="font-medium">Скорость 100K в сутки</span>
                            </div>
                        </div>
                    </div>
                </div>
