    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          {/* Email field */}
          <div>
            <label className="block text-white text-sm font-medium mb-2" htmlFor="login-email">
              E-mail или логин
            </label>
            <input
              id="login-email"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-white text-sm font-medium" htmlFor="login-password">
                Пароль
              </label>
